...
INSERT [dbo].[Book] ([boo_id], [cat_id], [boo_name], [boo_price], [boo_sale], [boo_description], [boo_status], [boo_img]) VALUES (N'BOOK002', N'CAT003', N'Ngan Nam Thang Long', CAST(1.99 AS Decimal(10, 2)), CAST(0.00 AS Decimal(10, 2)), N'Haha hihi', N'https://i.ibb.co/TTtwyrF/1000-Nam-Thang-Long.jpg')
