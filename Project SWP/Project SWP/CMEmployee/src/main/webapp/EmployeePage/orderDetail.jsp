    ...
    <body>
        ...
        <div class="container-fluid my-4" style="min-height: 100vh;
                ...
                <div class="col-lg-4">
                    <div class="box1">
                        ...
                        <div class="customer-info mt-4">
                            <div>Customer: <span><%= customerInfo.getString("cus_name")%></span> <a id="more" href="/employee/customerInfo/<%=orderId%>/<%= customerInfo.getString("cus_phone")%>"><i class="fa-solid fa-circle-info"></i></a></div>
            ...
            <div class="btnContainer">
                <div class="btnBack">
                    <a href="/employee/orderList"><button class="styledButton">Order List</button></a>
                </div>
            </div>
